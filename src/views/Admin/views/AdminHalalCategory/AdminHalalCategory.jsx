...
export class AdminHalalCategory extends React.Component {
    constructor(props){
        super(props);
        checkToken()
        this.state={
        ...
        return (
            <div>
                <Sidebar />
                    ...
                    :
                    <CategoryTable tableheader={tableheaders} tablerows={savings} addpage={"/admin/add_halal_category"} />}
            </div>    
        );
    }
}

export default AdminHalalCategory

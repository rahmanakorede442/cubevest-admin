...
class AddMarketCategory extends Component {
  constructor(props){
    super(props)
...
const connectedAddMarketCategory = connect(mapState, actionCreators)(AddMarketCategory);
export { connectedAddMarketCategory as AddMarketCategory };

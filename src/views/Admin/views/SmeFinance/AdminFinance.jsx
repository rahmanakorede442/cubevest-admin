        ...
        return (
            <div>
                <Sidebar />
                    ...
                    :
                    <TableData tableheader={tableheaders} tablerows={savings}/>}
            </div>    
        );
    }
}
...
const connectedAdminFinance = connect(mapState, actionCreators)(AdminFinance);
export { connectedAdminFinance as AdminFinance };

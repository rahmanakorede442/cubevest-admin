...
class AddMarketNews extends Component {
  constructor(props){
    super(props)
...
const connectedAddMarketNews = connect(mapState, actionCreators)(AddMarketNews);
export { connectedAddMarketNews as AddMarketNews };

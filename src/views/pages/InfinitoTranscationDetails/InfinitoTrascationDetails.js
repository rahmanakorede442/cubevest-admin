...
class InfinitoTranscationDetails extends Component {
  constructor(props){
    super(props)
...
fetchUsers = () =>{
    ...
    fetch(getConfig('infinitoSavingsTransactionsAdmin')+ data.id + `?token=`+user.token, requestOptions)
    .then(async response => {
...
export default withStyles({}, { withTheme: true })(
  withRouter(connect(mapState,  actionCreators)(InfinitoTranscationDetails))
);